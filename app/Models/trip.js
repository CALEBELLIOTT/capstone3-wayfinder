...
export class Trip {
  ...
  <div class="row m-3 rounded reservation-container shadow py-3" id="reservations${this.id}">
  </div>
  <div class="row">
    <div class="col-12">
      ...
      <div class="col-12">
        <form action="" onsubmit="app.reservationsController.addReservation('${this.id}')">
          <div class="row">
            ...
            <div class="col-1">
              <input class="form-control" type="number" name="cost" id="cost" placeholder="$0.00">
            </div>
